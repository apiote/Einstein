...
public class EndingDialogueActivity extends AppCompatActivity {
    ...
    private void initialiseColours() {
        playerColours[MobilePlayer.COLOUR_DARK] = getColour(this, R.color.dark);
        playerColours[MobilePlayer.COLOUR_LIGHT] = getColour(this, R.color.light);
    ...
    private void createResultsStringBounds() {
        ...
        p.getTextBounds(results[MobilePlayer.COLOUR_LIGHT] + getString(R.string.resultsSeparator) + results[MobilePlayer.COLOUR_DARK]
                , 0, results[MobilePlayer.COLOUR_LIGHT].length() + 1 + results[MobilePlayer.COLOUR_DARK].length(), bounds);
        boundsHeight = bounds.height();
    }

    private void createWonString() {
        if (winner == MobilePlayer.COLOUR_LIGHT) {
    ...
    private void printResults() {
        ...
        printResult(MobilePlayer.COLOUR_LIGHT, -1);
        printResult(MobilePlayer.COLOUR_DARK, 1);
